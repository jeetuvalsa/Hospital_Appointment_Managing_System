...
const HomePage = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row items-start md:items-center px-4 md:px-12 justify-center md:justify-between p-4 md:p-8 rounded-lg shadow-lg">
  ...
  {allDoctors ? (
    <div className="hidden md:block md:w-1/3 md:mr-24 overflow-y-auto max-h-80 bg-card text-card-foreground p-4 rounded-lg mt-4">
    ...
    <h1 className="text-xl font-semibold md:mr-32 mt-4 md:mt-0">
